  ...
  return (
    <div className="relative w-[340px] h-[450px] flex items-center justify-center my-20">
      ...
      >
        ...
        <button
          aria-label="like"
          className="absolute top-4 left-4 z-20 w-10 h-10 flex items-center justify-center rounded-full bg-black/40 border border-white/10 backdrop-blur-sm hover:bg-black/60 transition-colors"
        >
          <svg
        ...
        <div className="absolute left-0 right-0 bottom-0 z-20 px-6 pb-6 pt-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 text-right">
              <h3 className="text-white text-[20px] font-extrabold leading-6 mb-3">
                {title}
              </h3>

              <div className="flex flex-col gap-3 text-white/80 text-[13px]">
                {/* instructor and students row */}
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <button className="px-4 py-2 rounded-full border border-white/30 bg-transparent text-white text-sm font-medium hover:bg-white/10 transition-colors">
                      مشاهده دوره
                    </button>
                  </div>
